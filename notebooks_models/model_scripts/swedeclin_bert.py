...
tokenizer = AutoTokenizer.from_pretrained('/cephyr/NOBACKUP/groups/snic2021-23-309/project-data/nlp-for-healthcare/SweDeClin-BERT_copy/',local_files_only=True)
bert_model = AutoModel.from_pretrained('/cephyr/NOBACKUP/groups/snic2021-23-309/project-data/nlp-for-healthcare/SweDeClin-BERT_copy/',local_files_only=True)
